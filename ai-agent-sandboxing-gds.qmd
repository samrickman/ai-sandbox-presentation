...
Agent can't normally read, modify or execute directly on the host.
...
Code or data available to the agent in the sandbox is still at risk.
...
Sandbox has no effect on what an agent can do with its credentials.

:::
:::

::: {style="text-align:center;"}
![](./img/lethal_trifecta.png){width=40%}  
:::
...
::: {.caption}
Based on: [Sandboxing AI coding agents](https://www.samrickman.com/blog/ai-agent-sandboxes) and [How a sandboxed agent left code for my host to execute](https://www.samrickman.com/blog/ai-agent-sbx-clone-vs-direct-execute)
:::
